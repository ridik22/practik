...
void Metod(double a1, double b1, double c1)
{
        ...
        D2=pow(a1,2)-4*c1*b1;// cx^2+ax+b=0
            if (D >= 0)
            {
                ...
                {
                    cout<<"Rivnyannya "<<a1<<"x^2+"<<b1<<"x+"<<c1<<" mae vechestvenni korni "<<endl;
                    kol++;
                }
            ...
            if (D1 >= 0)
            {
                ...
                if (x1 - (int)x1 != 0 || x2 - (int)x2 != 0)
                {
                    cout<<"Rivnyannya "<<b1<<"x^2+"<<a1<<"x+"<<c1<<" mae vechestvenni korni "<<endl;
                    kol++;
                }
            }else{cout<<"Rivnyannya bx^2+ax+c=0 ne maye korniv\n";}
            if (D2 >= 0)
            {
                x1 = (-a1 + sqrt(D)) / (2 * c1);
                x2 = (-a1 - sqrt(D)) / (2 * c1);
                if (x1 - (int)x1 != 0 || x2 - (int)x2 != 0)
                {
                    cout<<"Rivnyannya "<<c1<<"x^2+"<<a1<<"x+"<<b1<<" mae vechestvenni korni "<<endl;
                    kol++;
                }
